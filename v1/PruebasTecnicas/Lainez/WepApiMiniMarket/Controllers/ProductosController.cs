...
using Infraestructura.MiniMarket.DAO;

namespace WepApiMiniMarket.Controllers
{
    public class ProductosController : ApiController 
    {
        private minimarketEntities db = new minimarketEntities();

        private Producto _serviceProductos = new Producto();
        ...
        public IQueryable<Productos> GetProductos()
        {
            ...
            //return _serviceProductos.ConsultarProductoSPTodos().ToList();
        }
